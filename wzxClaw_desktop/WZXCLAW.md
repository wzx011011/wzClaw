...
M1 验证与发布闸门。先对齐文档与代码现实，补齐 phases 6-9、mobile relay、packaged runtime、streaming UX 的总 UAT，再进入运行时状态收敛和高级功能稳定化。
...
- **剩余工作路线**：以 `.planning/ROADMAP.md` 的 M1-M6 为准，不再沿用“Phase 1-9 已完成就代表可发布”的旧假设
