// ============================================================
// /simplify — Code Review and Cleanup (from Claude Code)
// Reviews changed files for reuse, quality, and efficiency
// ============================================================
...
export function registerSimplifySkill(): void {
  registerBundledSkill({
    ...
    whenToUse:
      'Use when the user wants to review and clean up their recent code changes. Examples: "clean up my code", "review the diff for issues", "simplify".',
    userInvocable: true,
